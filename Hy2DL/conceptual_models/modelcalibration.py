...
def calibrate_single_basin(calibration_object, optimizer, path_output: str, random_seed: int = 42):
...
def calibrate_basins(training_object, optimization_method, basins, path_output: str, random_seed: int = 42):
    ...
    pool.starmap(
        ...
        [(training_object[basin], optimization_method, path_output, random_seed) for basin in basins],
    )
