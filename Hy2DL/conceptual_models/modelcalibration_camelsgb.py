...
class ModelCalibrationCamelsGB(ModelCalibration):
    def __init__(
        ...
        super(ModelCalibrationCamelsGB, self).__init__(
            model=model,
            path_data=path_data,
            basin_id=basin_id,
    ...
    def _read_data(self) -> Dict[str, pd.DataFrame]:
        ...
        path_timeseries = (
            self.path_data + "/timeseries/CAMELS_GB_hydromet_timeseries_" + self.basin_id + "_19701001-20150930.csv"
        )
